      ...
      <div className="welcome-container">
        <div className="welcome-header">
          ...
          <div className="welcome-content">
            ...
            <h2>Explore Our Micro-Frontend Architecture</h2>
            
            <div className="welcome-description">
              <p className="primary-description">
                This application demonstrates a modern micro-frontend architecture using React 19.1, 
                TypeScript, and Module Federation.
              </p>
              <p className="secondary-description">
                Each micro-frontend can be developed, deployed, and scaled independently while 
